...
serviceCollection.AddScoped<IMovimentacaoContaCorrenteRepository, MovimentacaoContaCorrenteRepository>();
...
serviceCollection.AddScoped<IMovimentacaoContaPoupancaRepository, MovimentacaoContaPoupancaRepository>();
...
var _movimentacaoContaCorrenteRepository = serviceProvider.GetService<IMovimentacaoContaCorrenteRepository>();
var _movimentacaoContaPoupancaRepository = serviceProvider.GetService<IMovimentacaoContaPoupancaRepository>();
...
var _aplicacaoFinanceira = new AplicacaoFinanceira(
                ...
                _movimentacaoContaPoupancaRepository,
                _movimentacaoContaCorrenteRepository,               
...
_aplicacaoFinanceira.RetornarSaldoContaCorrente("1", DateOnly.FromDateTime(DateTime.Now));
...
_aplicacaoFinanceira.RetornarSaldoContaCorrente("2", DateOnly.FromDateTime(DateTime.Now));
...
_aplicacaoFinanceira.RetornarSaldoContaCorrente("3", DateOnly.FromDateTime(DateTime.Now));
...
_aplicacaoFinanceira.RetornarSaldoContaPoupanca("1", DateOnly.FromDateTime(DateTime.Now));
...
_aplicacaoFinanceira.RetornarSaldoContaInvestimento("1", DateOnly.FromDateTime(DateTime.Now));
Console.WriteLine("----------------------------------------");
